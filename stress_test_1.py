...
class OrderConsumer(threading.Thread):
    ...
    def process_message(self, ch, method, properties, body):
        ...
        # Removed logging of processing message

        time.sleep(0.5)  # Simulate processing time reduced to 0.5 sec
        ...
        # Removed logging of processed message

    def run(self):
        # Removed logging of starting consumer
        try:
...
def start_producers():
    ...
    try:
        while True:
            ...
            for _ in range(100):  # Publish 100 messages
            ...
            sleep_time = max(0, 1 - elapsed)  # Adjust sleep to maintain ~100 messages per second
            time.sleep(sleep_time)
    except KeyboardInterrupt:
        # Removed logging of stopped sending orders
        connection.close()
